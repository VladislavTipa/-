#include "form3_3.h"
#include "ui_form3_3.h"

#include "../CustomWidget/qimagewidget.h"

Form3_3::Form3_3(QWidget *parent) :
    QWidget(parent)
{
    setWindowTitle("Просмотр 3 x 3");
    ...
    QImageWidget* image3_3 = new QImageWidget();

    image1_1 -> setMinimumSize(300, 300);
    image1_2 -> setMinimumSize(300, 300);
    image1_3 -> setMinimumSize(300, 300);
    ...
    image3_3 -> setMinimumSize(300, 300);
    ...
    GLayuot_skrean -> addWidget(image3_3, 2, 2);
    ...
    connect(button_exit, &QPushButton::clicked, this, &Form3_3::ClikedSlotExit);
    connect(Foto, &QPushButton::clicked, this, &Form3_3::Foto_3_3);
}
...
void Form3_3::ClikedSlotExit()
{
    this->close();
    emit firstwindow();
}

void Form3_3::Foto_3_3()
{
}
